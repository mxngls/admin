...
export default function ProductTableOptionContainer({
  ...
  return (
    <div className="sticky left-0 top-0 z-50 flex h-[11.75rem] w-full flex-wrap items-center justify-start gap-y-3 gap-x-6 bg-white p-4 xxs:h-[8.25rem] sm:h-[8.25] sm:gap-x-12 md:h-[5.134rem]">
      ...
      ></input>
      <div className="top-0 flex h-[44px] flex-row items-center">
        <Button type={"button"} onClickHandler={() => setOpenDialog(true)}>
          <Plus className="float-left" />
          <span className="overflow-hidden whitespace-nowrap">Add Product</span>
        </Button>
      </div>
    </div>
  );
